...
extension FlowRepresentable {
    ...
    public static func _factory<FR: FlowRepresentable>(_ type: FR.Type) -> FR { Self() as! FR }
    // swiftlint:disable:next force_cast
    public static func _factory<FR: FlowRepresentable>(_ type: FR.Type, with args: WorkflowInput) -> FR { Self(with: args) as! FR }
}
