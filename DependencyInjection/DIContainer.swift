...
public extension Workflow {
    ...
    /// - Returns: `Workflow`
    func thenPresent<FR>(_ type:FR.Type, presentationType:PresentationType = .default, staysInViewStack:@escaping @autoclosure () -> ViewPersistance = .default, dependencyInjectionSetup: ((Container) -> Void)? = nil) -> Workflow<FR> where FR: FlowRepresentable {
    ...
    /// - Parameter dependencyInjectionSetup: A closure that hands off a `Container` for you to set up Dependency Injection
    /// - Returns: `Workflow`
    convenience init(_ type:F.Type, presentationType:PresentationType = .default, staysInViewStack:@escaping @autoclosure () -> ViewPersistance = .default, dependencyInjectionSetup: ((Container) -> Void)? = nil) {
        dependencyInjectionSetup?(Workflow.defaultContainer)
    ...
    /// - Parameter dependencyInjectionSetup: A closure that hands off a `Container` for you to set up Dependency Injection
    /// - Returns: `Workflow`
    func thenPresent<FR>(_ type:FR.Type, presentationType:PresentationType = .default, staysInViewStack:@escaping (FR.WorkflowInput) -> ViewPersistance, dependencyInjectionSetup: ((Container) -> Void)? = nil) -> Workflow<FR> where FR: FlowRepresentable {
        let wf = Workflow<FR>(first)
        dependencyInjectionSetup?(Workflow.defaultContainer)
        wf.append(FlowRepresentableMetaData(type,
                                            presentationType: presentationType,
    ...
    /// - Parameter dependencyInjectionSetup: A closure that hands off a `Container` for you to set up Dependency Injection
    /// - Returns: `Workflow`
    convenience init(_ type:F.Type, presentationType:PresentationType = .default, staysInViewStack:@escaping (F.WorkflowInput) -> ViewPersistance, dependencyInjectionSetup: ((Container) -> Void)? = nil) {
        dependencyInjectionSetup?(Workflow.defaultContainer)
        self.init(FlowRepresentableMetaData(type,
                                            presentationType: presentationType,
                                            staysInViewStack: { data in
    ...
    /// - Parameter dependencyInjectionSetup: A closure that hands off a `Container` for you to set up Dependency Injection
    /// - Returns: `Workflow`
    func thenPresent<FR>(_ type:FR.Type, presentationType:PresentationType = .default, staysInViewStack:@escaping () -> ViewPersistance, dependencyInjectionSetup: ((Container) -> Void)? = nil) -> Workflow<FR> where FR: FlowRepresentable, FR.WorkflowInput == Never {
        let wf = Workflow<FR>(first)
        dependencyInjectionSetup?(Workflow.defaultContainer)
        wf.append(FlowRepresentableMetaData(type,
                                            presentationType: presentationType,
    ...
    /// - Parameter dependencyInjectionSetup: A closure that hands off a `Container` for you to set up Dependency Injection
    /// - Returns: `Workflow`
    convenience init(_ type:F.Type, presentationType:PresentationType = .default, staysInViewStack:@escaping () -> ViewPersistance, dependencyInjectionSetup: ((Container) -> Void)? = nil) where F.WorkflowInput == Never {
        dependencyInjectionSetup?(Workflow.defaultContainer)
        self.init(FlowRepresentableMetaData(type,
                                            presentationType: presentationType,
                                            staysInViewStack: { _ in
