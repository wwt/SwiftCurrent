...
extension FlowRepresentableMetadata {
    private static func createForTests<FR: FlowRepresentable>(_: FR.Type) -> FlowRepresentableMetadata {
        .init(FR.self, flowPersistence: { _ in .default })
    }
}

extension AnyWorkflow.Element {
    private static func createForTests<FR: FlowRepresentable>(_ :FR.Type) -> AnyWorkflow.Element {
