        ...
        let expectViewLoaded = ViewHosting.loadView(
            ...
            .onFinish { _ in
                ...
                try fr1.actualView().inspect { fr1 in
                    ...
                    try fr1.find(ViewType.NavigationLink.self).view(WorkflowItem<FR2, Never, FR2>.self).actualView().inspect { fr2 in
    ...
    func testLargeWorkflowCanBeFollowed() throws {
        ...
        let expectViewLoaded = ViewHosting.loadView(
            ...
            try fr1.actualView().inspect { fr1 in
                ...
                try fr1.find(ViewType.NavigationLink.self).view(WorkflowItem<FR2, WorkflowItem<FR3, WorkflowItem<FR4, WorkflowItem<FR5, WorkflowItem<FR6, WorkflowItem<FR7, Never, FR7>, FR6>, FR5>, FR4>, FR3>, FR2>.self).actualView().inspect { fr2 in
                    XCTAssert(try fr1.find(ViewType.NavigationLink.self).isActive())
                    ...
                    try fr2.actualView().inspect { fr2 in
                        ...
                        try fr2.find(ViewType.NavigationLink.self).view(WorkflowItem<FR3, WorkflowItem<FR4, WorkflowItem<FR5, WorkflowItem<FR6, WorkflowItem<FR7, Never, FR7>, FR6>, FR5>, FR4>, FR3>.self).actualView().inspect { fr3 in
                            ...
                            try fr3.actualView().inspect { fr3 in
                                ...
                                try fr3.find(ViewType.NavigationLink.self).view(WorkflowItem<FR4, WorkflowItem<FR5, WorkflowItem<FR6, WorkflowItem<FR7, Never, FR7>, FR6>, FR5>, FR4>.self).actualView().inspect { fr4 in
                                    ...
                                    try fr4.actualView().inspect { fr4 in
                                        ...
                                        try fr4.find(ViewType.NavigationLink.self).view(WorkflowItem<FR5, WorkflowItem<FR6, WorkflowItem<FR7, Never, FR7>, FR6>, FR5>.self).actualView().inspect { fr5 in
                                            ...
                                            try fr5.actualView().inspect { fr5 in
                                                ...
                                                try fr5.find(ViewType.NavigationLink.self).view(WorkflowItem<FR6, WorkflowItem<FR7, Never, FR7>, FR6>.self).actualView().inspect { fr6 in
                                                    ...
                                                    try fr6.actualView().inspect { fr6 in
                                                        ...
                                                        try fr6.find(ViewType.NavigationLink.self).view(WorkflowItem<FR7, Never, FR7>.self).actualView().inspect { fr7 in
