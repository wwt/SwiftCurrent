...
final class PersistenceTests: XCTestCase, View {
    ...
    func testRemovedAfterProceeding_OnFirstItemInAWorkflow() async throws {
        ...
        XCTAssertThrowsError(try wfr2.find(FR2.self).actualView().backUpInWorkflow())
        XCTAssertNoThrow(try wfr2.find(FR2.self).actualView().proceedInWorkflow())
        let wfr3 = try await wfr2.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr3.find(FR3.self).actualView().proceedInWorkflow())
        let wfr4 = try await wfr3.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr4.find(FR4.self).actualView().proceedInWorkflow())
    }
    ...
    func testRemovedAfterProceeding_OnMiddleItemInAWorkflow() async throws {
        ...
        XCTAssertNoThrow(try wfr1.find(FR1.self).actualView().proceedInWorkflow())
        var wfr2 = try await wfr1.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr2.find(FR2.self).actualView().proceedInWorkflow())
        var wfr3 = try await wfr2.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr3.find(FR3.self).actualView().backUpInWorkflow())

        XCTAssertNoThrow(try wfr1.find(FR1.self).actualView().proceedInWorkflow())
        wfr2 = try await wfr1.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr2.find(FR2.self).actualView().proceedInWorkflow())
        wfr3 = try await wfr2.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr3.find(FR3.self).actualView().proceedInWorkflow())
        let wfr4 = try await wfr3.extractWrappedWorkflowItem()
        XCTAssertNoThrow(try wfr4.find(FR4.self).actualView().proceedInWorkflow())
    }
