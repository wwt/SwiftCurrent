...
public struct WorkflowItem<FlowRepresentableType: FlowRepresentable & View, Content: View>: _WorkflowItemProtocol { // swiftlint:disable:this generic_type_name
    ...
    init(_ item: FlowRepresentableType.Type) {
        let metadata = FlowRepresentableMetadata(FlowRepresentableType.self,
                                                 launchStyle: .new,
                                                 flowPersistence: flowPersistenceClosure,
                                                 flowRepresentableFactory: factory)
    ...
    init<VC: FlowRepresentable & UIViewController>(_: VC.Type) where Content == ViewControllerWrapper<VC>, FlowRepresentableType == ViewControllerWrapper<VC> {
